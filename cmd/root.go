...
func init() {
	...
	rootCmd.PersistentFlags().StringVarP(&prometheus, "prometheus", "", "", "Address of Prometheus endpoint")
	...
	if err := viper.BindPFlag("prometheus", rootCmd.PersistentFlags().Lookup("prometheus")); err != nil {
		fmt.Println(err)
		os.Exit(1)
	}
}
